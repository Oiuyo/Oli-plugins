...
@Slf4j
@Singleton
class OliMuseumOverlay extends OverlayPanel {
    private final OliMuseumPlugin plugin;
    private final OliMuseumConfig config;

    String timeFormat;
    private String infoStatus = "Starting...";

    @Inject
    private OliMuseumOverlay(final OliMuseumPlugin plugin, final OliMuseumConfig config) {
        super(plugin);
